...
const Sidebar = () => {
  const navItems = [
    ...
    { name: 'Content Approval', path: '/admin/content', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
    ...
    { name: 'Question Bank', path: '/admin/questions', icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z' },
    ...
    <div className="hidden md:flex md:flex-shrink-0">
      <div className="flex flex-col w-64 h-full">
        <div className="flex items-center h-16 flex-shrink-0 px-4 bg-indigo-600">
          <h1 className="text-white text-xl font-bold">Synapaxon Admin</h1>
        </div>
        <div className="flex-1 flex flex-col overflow-y-auto bg-white border-r">
          <nav className="flex-1 px-2 py-4 space-y-1">
            {navItems.map((item) => (
              ...
              >
                <svg
                  className={`mr-3 h-5 w-5 ${item.path === window.location.pathname ? 'text-indigo-500' : 'text-gray-400 group-hover:text-gray-500'}`}
